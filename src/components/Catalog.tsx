    ...
    return (
        <section id="katalog" className="py-16 px-5 bg-[#FAFAFA]">
            <div className="max-w-7xl mx-auto">
                ...
                {selected && (
                    <div
                        className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 bg-gray-900/40 backdrop-blur-md"
                    ...
                    >
                        <motion.div
                            ...
                            className="relative bg-[#FAFAFA] w-full max-w-4xl rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col md:flex-row max-h-[95vh] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)]"
                        ...
                        >
                            ...
                            <div className="w-full md:w-1/2 p-2 hidden md:block relative z-10">
                                <div className="w-full h-full bg-gray-100 rounded-[2.5rem] overflow-hidden relative shadow-inner">
                                    <img
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-transparent to-transparent flex items-end p-8">
                                        <a
                                            ...
                                            target="_blank"
                                            className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md border border-white/30 text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-gray-900 transition-all"
                                        >
                                            <ExternalLink className="w-4 h-4" /> Buka Live Demo
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Modal Content */}
                            <div className="flex-1 p-8 md:p-12 flex flex-col overflow-y-auto relative bg-transparent z-10">
                                <div className="relative z-10 flex flex-col h-full">
                                    <button
                                        onClick={handleCloseModal}
                                        className="absolute top-0 right-0 w-10 h-10 flex items-center justify-center rounded-full bg-white shadow-sm border border-gray-100 text-gray-400 hover:bg-gray-50 hover:text-gray-900 transition-colors"
                                    >
                                        <X className="w-5 h-5" />
                                    </button>

                                    <div className="mb-8 pr-12 pt-4">
                                        <span className="inline-block px-4 py-1.5 bg-sky-100 text-sky-700 text-[10px] font-black rounded-full uppercase tracking-widest mb-4 border border-sky-200/50 shadow-sm">
                                            {selected.kategori}
                                        </span>
                                        <h3 className="text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-gray-900 to-gray-600 mb-3 tracking-tight leading-none drop-shadow-sm">{selected.nama_tema}</h3>
                                    </div>

                                <div className="mb-10 py-6 border-y border-gray-100">
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">Harga Spesial</p>
                                    <div className="flex items-baseline gap-4">
                                        <span className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600">
                                        ...
                                        {!isOrdering ? (
                                            ...
                                            >
                                                <button
                                                    ...
                                                    className="w-full py-4 bg-[#111111] text-white text-sm font-bold uppercase tracking-widest rounded-2xl hover:bg-sky-500 hover:shadow-xl hover:shadow-sky-500/20 transition-all duration-300"
                                                >
                                                    Pesan Tema Ini
                                                </button>
                                                <a
                                                    href={selected.link_demo}
                                                    target="_blank"
                                                    className="md:hidden flex items-center justify-center gap-2 w-full py-4 bg-gray-50 text-gray-900 text-sm font-bold uppercase tracking-widest rounded-2xl border border-gray-200"
                                                >
