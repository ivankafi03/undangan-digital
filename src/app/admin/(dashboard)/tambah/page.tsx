...
export default function AddTemaPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8 pb-20">
            <div>
                <h1 className="text-3xl font-bold text-slate-900">Tambah Tema Baru</h1>
                <p className="text-slate-500 mt-1">Lengkapi data di bawah untuk menambah tema ke katalog.</p>
            </div>
            ...
            <div className="bg-white rounded-[2rem] shadow-xl p-10 border border-slate-100">
                <form action={createTema} className="space-y-6">
                    ...
                    <p className="text-xs text-slate-400 ml-1">* Isi Harga Diskon hanya jika tema ini sedang promo.</p>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <input
                                ...
                                accept="image/*"
                                required
                                className="w-full px-6 py-4 rounded-2xl border-2 border-dashed border-slate-200 hover:border-purple-400 focus:outline-none transition-all text-slate-500 font-medium cursor-pointer file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-purple-100 file:text-purple-700 hover:file:bg-purple-200"
                            />
                        </div>
                        <p className="text-xs text-slate-400 ml-1 italic">* Format: JPG, PNG. Maksimal 2MB.</p>
                    </div>
